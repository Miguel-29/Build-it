   ...
   <div class="card-body ">
      ...
      <div class="row">
         ...
         <div class="col-sm-6 col-md-6">
            ...
            <div class="col-md-12">
               <div class="form-group has-default bmd-form-group">
                  {!!Form::password('password',array('placeholder'=>'Ingrese la contraseña del usuario','class'=>'form-control'))!!}
         ...
         <div class="col-sm-6 col-md-6">
            ...
            <div class="col-md-12">
               <div class="form-group has-default bmd-form-group">
                  {!!Form::password('password_repite',array('placeholder'=>'Repita la contraseña','class'=>'form-control'))!!}
