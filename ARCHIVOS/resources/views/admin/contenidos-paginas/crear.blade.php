...
<div class="side-app" >
    <div class="page-header">
        <h4 class="page-title">Crear Contenido para Página</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">Inicio</li>
            <li class="breadcrumb-item active" aria-current="page">Crear Contenido para Página</li>
        </ol>
    </div>
    {!!Form::open(array('url'=>'contenidos-paginas/crear','method'=>'post','class'=>'card','files'=>'true'))!!}
    @php
        $arrayPagina = [];
    ...
    <div class="card-body ">
            ...
            <div class="col-md-6 col-lg-6">
                ...
                <div class="col-md-12">
                    <div class="form-group has-default bmd-form-group">
                        {!!Form::text('nombre',old('nombre'),array('placeholder'=>'Ingrese el nombre del contenido','class'=>'form-control'))!!}
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="col-md-12">
                    <div class="form-group has-default bmd-form-group">
                        {!!Form::textarea('descripcion',old('descripcion'),array('placeholder'=>'Ingrese la descripcion','class'=>'form-control editor'))!!}
