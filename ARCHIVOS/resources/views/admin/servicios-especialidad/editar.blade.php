...
<div class="side-app" style="height:670px">
    <div class="page-header">
        <h4 class="page-title">Editar Servicios Especialidad: {{ $servicio->nombre }}</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">Inicio</li>
            <li class="breadcrumb-item active" aria-current="page">Editar Servicios Especialidad</li>
        </ol>
    </div>
    {!!Form::model($servicio,array('action'=>array('Admin\ServiciosEspecialidadController@actualizar',$servicio->idservicio),'method'=>'post','class'=>'card'))!!}
    <div class="card-body ">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="col-md-12">
                    <div class="form-group has-default bmd-form-group">
                        {!!Form::text('nombre',null,array('placeholder'=>'Ingrese el nombre del servicio','class'=>'form-control'))!!}
