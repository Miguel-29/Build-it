							...
							<div class="col-md-12">
								<div class="form-group has-default bmd-form-group">
									...
									" required>
										...
										@foreach ($professions as $_profession)
											<option value="{{ $_profession->id }}"
												@if($profession->id === $_profession->id) selected @endif
											>{{ $_profession->nombre }}</option>
										@endforeach
									</select>
				...
				<div class="card-footer ">
					<div class="row">
						<div class="col-md-12">
							...
							<a href="{{ route('areas-profesiones.index-by-use-group', $profession->id) }}" class="btn btn-link ml-auto">Volver</a>
						</div>
					</div>
				</div>
			</div>
