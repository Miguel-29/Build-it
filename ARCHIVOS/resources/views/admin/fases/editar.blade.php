...
<div class="side-app" style="height:670px">
    <div class="page-header">
        <h4 class="page-title">Editar Fase {{ $fase->nombre }}</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">Inicio</li>
            <li class="breadcrumb-item active" aria-current="page">Editar Fase</li>
        </ol>
    </div>
    {!!Form::model($fase,array('action'=>array('Admin\FasesController@actualizar',$fase->idfase),'method'=>'post','class'=>'card','files'=>'true'))!!}
    <div class="card-body ">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="col-md-12">
                    <div class="form-group has-default bmd-form-group">
                        {!!Form::text('nombre',null,array('placeholder'=>'Ingrese el nombre de la Fase','class'=>'form-control'))!!}
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6">
                ...
                <div class="col-md-12">
                    <div class="form-group has-default bmd-form-group">
                        {!!Form::textarea('descripcion', null,array('placeholder'=>'Ingrese la descripción de la Fase','class'=>'form-control', 'rows' => '3'))!!}
            ...
            <div class="col-md-6 col-lg-6">
                ...
                <div class="col-md-12">
                   ...
                   @else
                      <input type="file" name="image" id="image" class="dropify" data-default-file="/uploads/fases/{{ $fase->image }}" >
                   @endif
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <button type="button" class="btn btn-blue ml-auto"
                        onclick="document.location.href='{{ URL::to('fases/') }}'">Volver</button>
                </div>
            </div>
        </div>
    </div>
