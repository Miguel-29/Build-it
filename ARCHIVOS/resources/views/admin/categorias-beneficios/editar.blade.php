...
@section('content')
    <div class="side-app" style="height:670px">
        <div class="page-header">
            <h4 class="page-title">Editar Categoria de Beneficio {{ $categoria->nombre }}</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Editar Categoria de Beneficio </a></li>
                <li class="breadcrumb-item active" aria-current="page">Editar Categoria de Beneficio</li>
            </ol>
        </div>
        {!!Form::model($categoria,array('action'=>array('Admin\CategoriasBeneficiosController@actualizar',$categoria->idcategoria),'method'=>'post','class'=>'card'))!!}
        <div class="card-body ">
            <div class="row">
