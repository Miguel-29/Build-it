                                                                                                    ...
                                                                                                    @if($user->hasRole('Empresa'))
                                                                                                        @if($empresa->idempresa == $user->iduserrelacion)
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-6"></div>
                                                                                                                <div class="col-md-6">
                                                                                                                    <a href="{{URL::to('clientes/editar-empresa/empresa/'.$empresa->idempresa.'/revision-bim?disciplinas='.$disciplina->iddisciplina)}}" class="btn btn-primary ml-auto">Editar Revisión BIM</a>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        @endif
                                                                                                    @endif
                                                                                                    ...
                                                                                                    @if($user->hasRole('Empresa'))
                                                                                                        @if($empresa->idempresa == $user->iduserrelacion)
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-6"></div>
                                                                                                                <div class="col-md-6">
                                                                                                                    <a href="{{URL::to('clientes/editar-empresa/empresa/'.$empresa->idempresa.'/supervision-bim?disciplinas='.$disciplina->iddisciplina)}}" class="btn btn-primary ml-auto">Editar Supervisión BIM</a>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        @endif
                                                                                                    @endif
                                                                ...
                                                                <div class="tab_content">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-11 col-lg-11 ">
                                                                            ...
                                                                            <p><img src="{{URL::to('assets/front/images/imagenes/check.png')}}" align="left"><b>País:</b> {{$empresa->pais}}</p>
                                                                            <p><img src="{{URL::to('assets/front/images/imagenes/check.png')}}" align="left"><b>Nit:</b> {{$empresa->nit}}</p>
                                                                            <p><img src="{{URL::to('assets/front/images/imagenes/check.png')}}" align="left"><b>Fundación:</b> {{$empresa->anio_fundacion}}</p>
