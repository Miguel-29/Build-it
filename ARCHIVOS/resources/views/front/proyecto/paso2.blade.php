                                      ...
                                      <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="input-group radio-inf-adc">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Información adicional <small>(opcional)</small></label>
                                                        <div class="col-md-12">
                                    ...
                                    <div class="tab-pane" id="account">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="input-group">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Disponibilidad de licencia de construcción/Urbanización/Parcelación/Subdivisión *<small></small></label>
