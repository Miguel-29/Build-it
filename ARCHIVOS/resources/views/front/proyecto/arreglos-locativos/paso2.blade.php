                ...
                <div class="card-body p-6">
                    <div class="wizard-container">
                        <div class="wizard-card m-0" data-color="blue" id="wizardProfile">
                            {!!Form::model($proyecto,array('url'=>'clientes/crear-proyecto/'.$idproyecto.'/'.$idcliente.'/arreglos-locativos/paso-2','method'=>'post','class'=>'form-horizontal','files'=>'true','name'=>'formProyecto','id'=>'formProyecto'))!!}
                                <div class="wizard-navigation">
                                    <ul class="nav nav-pills">
                                        <li><a href="#about" data-toggle="tab">General</a></li>
                                        <li><a href="#account" data-toggle="tab">Especifíca</a></li>
                                    </ul>
                                </div>
                                      ...
                                      <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="input-group radio-inf-adc">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">¿Cuáles Arreglos locativos o específicos necesitas?</label>
                                                        <div class="col-md-12">
