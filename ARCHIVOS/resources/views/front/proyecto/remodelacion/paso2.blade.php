                ...
                <div class="card-body p-6">
                    <div class="wizard-container">
                        <div class="wizard-card m-0" data-color="blue" id="wizardProfile">
                            {!!Form::model($proyecto,array('url'=>'clientes/crear-proyecto/'.$idproyecto.'/'.$idcliente.'/remodelacion/paso-2','method'=>'post','class'=>'form-horizontal','files'=>'true','name'=>'formProyecto','id'=>'formProyecto'))!!}
                                <div class="wizard-navigation">
                                    <ul class="nav nav-pills">
                                        <li><a href="#admin" data-toggle="tab">Administración</a></li>
                                        <li><a href="#about" data-toggle="tab">General</a></li>
                                        <li><a href="#account" data-toggle="tab">Específica</a></li>
                                      ...
                                      <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="input-group radio-inf-adc">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">¿Cuáles modificaciones para tu predio has contemplado? </label>
                                                        <div class="col-md-12">
                                    ...
                                    <div class="tab-pane" id="account">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="input-group">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Uso u ocupación *<small></small></label>
                                                ...
                                                <div class="input-group">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">En el predio se encuentra alguna ediﬁcacion o estructura para demoler *<small></small></label>
                                                ...
                                                <div class="input-group">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Tiempo para la ejecución del proyecto *<small></small></label>
                                                ...
                                                <div class="input-group">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Método de pago de la ejecución del proyecto *<small></small></label>
                                                        {!!Form::select('ie_metodo_pago_ejecucion', [
                                                            '' => 'Seleccione',
                                                            'dinero propio' => 'Dinero Propio',
                                                            'accionistas' => 'Accionistas',
                                                            'financiamiento por credito constructor' => 'Financiamiento por crédito constructor',
                                                            'banco'=> 'Banco',
                                                        ...
                                                        <!--<select class="form-control " data-placeholder="Choose one"  name="ie_metodo_pago_ejecucion" id="ie_metodo_pago_ejecucion" tabindex="-1" aria-hidden="true">
                                                            ...
                                                            <option value="financiamiento por credito constructor">Financiamiento por crédito constructor</option>
                                    ...
                                    <div class="tab-pane" id="admin">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="input-group">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Administración<small></small></label>
                                                ...
                                                <div class="input-group" id="empresa" style="display: none">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">Área<small></small></label>
                                                            {!!Form::text('ad_area_contratista_emp',null,array('placeholder'=>'Área','class'=>'form-control'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="input-group">
                                                        <div class="form-group label-floating">
            ...
            function checkGrupo(nombre){
                ...
                if (nombre == "Vivienda Bifamiliar" || 
                    ...
                    nombre == "Parqueaderos"){
                        ...
                        opciones ='<option value="I - Estructuras de ocupación normal" selected>I - Estructuras de ocupación normal</option>';
                        ...
                        nombre == "Edificios de administración gubernamental"){

                            opciones ='<option value="II - Estructuras de ocupación especial" selected>II - Estructuras de ocupación especial</option>';
                        ...
                        nombre == "Edificios de policías" ||
                        nombre == "Edificios fuerzas armadas" ||
                        nombre == "Sedes de oficinas de prevención y atención de desastres" ||
                        nombre == "Garajes de vehículos de emergencia" ||
                        nombre == "Edificios de centros de atención de emergencias" ||
                        nombre == "Guarderías" ||
                        nombre == "Centros de enseñanza"){

                            opciones ='<option value="III - Edicaciones para la atención a la comunidad" selected>III - Edicaciones para la atención a la comunidad</option>';
