...
@extends($rutaNombre == 'freelancer.paso4' ? 'front.layouts.pasos' : 'front.layouts.proyecto')
@section('content')
<div class="container">
    @if($rutaNombre == 'freelancer.paso4')
        <div class="row mb-6">
    ...
    <div class="row">
        ...
        <div class="col-8">
            @if($rutaNombre == 'freelancer.paso4')
                {!!Form::model($freelancer,array('url'=>'clientes/crear-f/'.$tipo.'/'.$idfreelancer.'/paso-4','method'=>'post','class'=>'card', 'style' => 'margin-bottom: 70px'))!!}
            @else
                {!!Form::model($freelancer,array('url'=>'clientes/crear-f/'.$tipo.'/'.$idfreelancer.'/paso-4?editar='.$idfreelancer,'method'=>'post','class'=>'card', 'style' => 'margin-bottom: 70px'))!!}
            @endif    
                ...
                <div class="card-header">
                    <h3 class="card-title">{{$rutaNombre == 'freelancer.paso4' ? 'Crea tu cuenta' : 'Editar Perfil'}}</h3>
                    <div class="row">
                ...
                @php
                    ...
                    if($experiencia !== NULL){
                        $ae= explode(' ', $experiencia->anios_experiencia);
                        $anios_experiencia = $ae[0];
                        ...
                        <div class="col-md-6 col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="row col-md-12">
                                    {!!Form::number('anios_experiencia',$anios_experiencia,array('placeholder'=>'Años de Experiencia','class'=>'form-control col-md-9'))!!}
                                    <span class="col-md-3">Años</span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block has-error"  style="color:#f4981a"> {{$errors->first('m2_disenados')}}</p>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block has-error"  style="color:#f4981a"> {{$errors->first('actividades_desempena')}}</p>
                            </div>
                            <div class="form-group">
                                ...
                                <p class="help-block has-error"  style="color:#f4981a"> {{$errors->first('uso_software')}}</p>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Disponibilidad de Personal *</label>
                                {!!Form::select('disponibilidad_personal', [
                                    '' => 'Selecciona una opción',
                                    'Solo el freelancer'=>'Solo el freelancer',
                                    '2 a 4 empleados'=>'2 a 4 empleados',
                                    '5 en adelante'=>'5 en adelante'],
                                    $disponibilidad_personal,
                                    array('class'=>'form-control','id' => 'disponibilidad_personal')
                                    )!!}
                                    <p class="help-block has-error"  style="color:#f4981a"> {{$errors->first('disponibilidad_personal')}}</p>
                            </div>
                            <div class="form-group">
                                ...
                                <p class="help-block has-error"  style="color:#f4981a"> {{$errors->first('certificados_cursos_seminarios')}}</p>
                            </div>
                            <div class="form-group">
                                ...
                                {!!Form::select('disponibilidad_viajar', [
                                    ...
                                    <p class="help-block has-error"  style="color:#f4981a"> {{$errors->first('disponibilidad_viajar')}}</p>
                            </div>
                            <div class="form-group">
                                
                                @if($idioma->count() > 0)
                                    <label class="form-label"><b>Idiomas Guardados</b></label><br>
                                    <div class="card">
                                ...
                                @endif
                                <br>
                                <label class="form-label"><b>Agregar Idioma</b></label><br>
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('tipo_contratacion', [
                                    ...
                                    <p class="help-block has-error"  style="color:#f4981a"> {{$errors->first('tipo_contratacion')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-footer text-right">
                    <div class="d-flex">
                        <a href="{{$rutaNombre == 'freelancer.paso4' ? '/clientes/crear-f/'.$tipo.'/'.$idfreelancer.'/paso-3' : '/clientes/perfil-freelancer/'.$freelancer->idfreelancer}}" class="btn btn-link">Cancelar</a>
